...
public class IfElself {
	...
	public static void main(String[] args) {
		...
		if (num1 > num2) {
			...
			int day = 6;
			if (day == 1) {
				System.out.println("Today is Mionday.I have to go to work");
				...
				System.out.println("Today is Friday.Weekene is here");

			} else if (day == 6) {
				System.out.println("Today is Saturday.My favourite coding class");

			} else if (day == 7) {
				System.out.println("I love spending Sunday at Syntax");
			} else {

				System.out.println("I donot know this day");
